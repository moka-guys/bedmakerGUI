...
- bed_file_details(file_id): Displays details of a specific BED file, including entries and version history.
...
- download_bed_file(file_id): Downloads a specific BED file.
"""
